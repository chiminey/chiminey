...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('smartconnectorscheduler_context', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.Context'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.parent'
        db.delete_column('smartconnectorscheduler_context', 'parent_id')
