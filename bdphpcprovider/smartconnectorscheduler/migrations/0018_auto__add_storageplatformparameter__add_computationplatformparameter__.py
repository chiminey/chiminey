...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoragePlatformParameter'
        db.create_table('smartconnectorscheduler_storageplatformparameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.ParameterName'])),
            ('paramset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.StoragePlatformParameterSet'])),
            ('value', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('smartconnectorscheduler', ['StoragePlatformParameter'])

        # Adding model 'ComputationPlatformParameter'
        db.create_table('smartconnectorscheduler_computationplatformparameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.ParameterName'])),
            ('paramset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.ComputationPlatformParameterSet'])),
            ('value', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('smartconnectorscheduler', ['ComputationPlatformParameter'])

        # Deleting field 'StoragePlatformParameterSet.computation_platform'
        db.delete_column('smartconnectorscheduler_storageplatformparameterset', 'computation_platform_id')

        # Adding field 'StoragePlatformParameterSet.storage_platform'
        db.add_column('smartconnectorscheduler_storageplatformparameterset', 'storage_platform',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smartconnectorscheduler.StoragePlatform']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StoragePlatformParameter'
        db.delete_table('smartconnectorscheduler_storageplatformparameter')

        # Deleting model 'ComputationPlatformParameter'
        db.delete_table('smartconnectorscheduler_computationplatformparameter')

        # Adding field 'StoragePlatformParameterSet.computation_platform'
        db.add_column('smartconnectorscheduler_storageplatformparameterset', 'computation_platform',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smartconnectorscheduler.StoragePlatform']),
                      keep_default=False)

        # Deleting field 'StoragePlatformParameterSet.storage_platform'
        db.delete_column('smartconnectorscheduler_storageplatformparameterset', 'storage_platform_id')
    ...
    models = {
        ...
        'smartconnectorscheduler.computationplatformparameter': {
            'Meta': {'ordering': "('name',)", 'object_name': 'ComputationPlatformParameter'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartconnectorscheduler.ParameterName']"}),
            'paramset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartconnectorscheduler.ComputationPlatformParameterSet']"}),
        ...
        'smartconnectorscheduler.storageplatformparameter': {
            'Meta': {'ordering': "('name',)", 'object_name': 'StoragePlatformParameter'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartconnectorscheduler.ParameterName']"}),
            'paramset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartconnectorscheduler.StoragePlatformParameterSet']"}),
            'value': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        'smartconnectorscheduler.storageplatformparameterset': {
            ...
            'ranking': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'schema': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartconnectorscheduler.Schema']"}),
            'storage_platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartconnectorscheduler.StoragePlatform']"})
        },
