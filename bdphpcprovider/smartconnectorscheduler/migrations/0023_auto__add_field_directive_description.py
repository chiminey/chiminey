...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Directive.description'
        db.add_column('smartconnectorscheduler_directive', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Directive.description'
        db.delete_column('smartconnectorscheduler_directive', 'description')
