...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('smartconnectorscheduler_userprofile', 'company', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'UserProfile.nickname'
        db.alter_column('smartconnectorscheduler_userprofile', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'StageParameter.value'
        db.alter_column('smartconnectorscheduler_stageparameter', 'value', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ContextParameter.value'
        db.alter_column('smartconnectorscheduler_contextparameter', 'value', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.company'
        db.alter_column('smartconnectorscheduler_userprofile', 'company', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'UserProfile.nickname'
        db.alter_column('smartconnectorscheduler_userprofile', 'nickname', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'StageParameter.value'
        db.alter_column('smartconnectorscheduler_stageparameter', 'value', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfileParameter.value'
        db.alter_column('smartconnectorscheduler_userprofileparameter', 'value', self.gf('django.db.models.fields.TextField')(default=''))
