...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Directive.hidden'
        db.add_column('smartconnectorscheduler_directive', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Directive.hidden'
        db.delete_column('smartconnectorscheduler_directive', 'hidden')
