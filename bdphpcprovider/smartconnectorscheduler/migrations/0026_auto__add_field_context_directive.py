...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.directive'
        db.add_column('smartconnectorscheduler_context', 'directive',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.Directive'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.directive'
        db.delete_column('smartconnectorscheduler_context', 'directive_id')
