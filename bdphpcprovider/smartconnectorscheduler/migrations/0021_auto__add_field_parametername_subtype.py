...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParameterName.subtype'
        db.add_column('smartconnectorscheduler_parametername', 'subtype',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParameterName.subtype'
        db.delete_column('smartconnectorscheduler_parametername', 'subtype')
