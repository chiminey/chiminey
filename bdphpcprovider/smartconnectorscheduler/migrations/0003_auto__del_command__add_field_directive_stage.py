...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Directive.stage'
        db.add_column('smartconnectorscheduler_directive', 'stage',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Directive.stage'
        db.delete_column('smartconnectorscheduler_directive', 'stage_id')
