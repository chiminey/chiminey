...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Platform.root_path'
        db.add_column('smartconnectorscheduler_platform', 'root_path',
                      self.gf('django.db.models.fields.CharField')(default='/home/centos', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Platform.root_path'
        db.delete_column('smartconnectorscheduler_platform', 'root_path')
