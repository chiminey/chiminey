...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ComputationPlatform'
        db.delete_table('smartconnectorscheduler_computationplatform')
        ...
        db.create_table('smartconnectorscheduler_platforminstance', (
            ...
            ('schema_namespace_prefix', self.gf('django.db.models.fields.CharField')(default='http://rmit.edu.au/schemas/platform/computation', max_length=512)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table('smartconnectorscheduler_storageplatformparameterset', (
            ('ranking', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('storage_platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.StoragePlatform'])),
            ('schema', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.Schema'])),
        ))
        db.send_create_signal('smartconnectorscheduler', ['StoragePlatformParameterSet'])

        # Adding model 'ComputationPlatform'
        db.create_table('smartconnectorscheduler_computationplatform', (
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.UserProfile'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schema_namespace_prefix', self.gf('django.db.models.fields.CharField')(default='http://rmit.edu.au/schemas/platform/computation', max_length=512)),
        ))
        db.send_create_signal('smartconnectorscheduler', ['ComputationPlatform'])
