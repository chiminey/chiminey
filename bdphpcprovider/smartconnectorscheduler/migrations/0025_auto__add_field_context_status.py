...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Context.status'
        db.add_column('smartconnectorscheduler_context', 'status',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Context.status'
        db.delete_column('smartconnectorscheduler_context', 'status')
