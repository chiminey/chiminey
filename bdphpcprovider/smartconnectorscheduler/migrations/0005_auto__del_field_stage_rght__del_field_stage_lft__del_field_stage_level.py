...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Stage.rght'
        db.delete_column('smartconnectorscheduler_stage', 'rght')

        # Deleting field 'Stage.lft'
        db.delete_column('smartconnectorscheduler_stage', 'lft')

        # Deleting field 'Stage.level'
        db.delete_column('smartconnectorscheduler_stage', 'level')

        # Deleting field 'Stage.tree_id'
        db.delete_column('smartconnectorscheduler_stage', 'tree_id')


        # Changing field 'Stage.parent'
        db.alter_column('smartconnectorscheduler_stage', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.Stage'], null=True))

    def backwards(self, orm):
        # Adding field 'Stage.rght'
        db.add_column('smartconnectorscheduler_stage', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Stage.lft'
        db.add_column('smartconnectorscheduler_stage', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Stage.level'
        db.add_column('smartconnectorscheduler_stage', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Stage.tree_id'
        db.add_column('smartconnectorscheduler_stage', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


        # Changing field 'Stage.parent'
        db.alter_column('smartconnectorscheduler_stage', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['smartconnectorscheduler.Stage']))
