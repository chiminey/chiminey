...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('smartconnectorscheduler_computationplatform', (
            ...
            ('root_path', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('private_key_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
    ...
    models = {
        ...
        'smartconnectorscheduler.computationplatform': {
            ...
            'private_key_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'root_path': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
