...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParameterName.description'
        db.add_column('smartconnectorscheduler_parametername', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParameterName.description'
        db.delete_column('smartconnectorscheduler_parametername', 'description')
