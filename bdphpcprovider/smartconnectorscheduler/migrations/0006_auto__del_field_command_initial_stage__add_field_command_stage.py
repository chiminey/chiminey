...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Command.initial_stage'
        db.delete_column('smartconnectorscheduler_command', 'initial_stage_id')

        # Adding field 'Command.stage'
        db.add_column('smartconnectorscheduler_command', 'stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.Stage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Command.initial_stage'
        db.add_column('smartconnectorscheduler_command', 'initial_stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['smartconnectorscheduler.Stage']),
                      keep_default=False)

        # Deleting field 'Command.stage'
        db.delete_column('smartconnectorscheduler_command', 'stage_id')
