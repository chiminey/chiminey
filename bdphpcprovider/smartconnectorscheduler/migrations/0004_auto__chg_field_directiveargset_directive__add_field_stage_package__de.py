...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DirectiveArgSet.directive'
        db.alter_column('smartconnectorscheduler_directiveargset', 'directive_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.Stage']))
        # Adding field 'Stage.package'
        db.add_column('smartconnectorscheduler_stage', 'package',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Deleting field 'Command.path'
        db.delete_column('smartconnectorscheduler_command', 'path')


    def backwards(self, orm):

        # Changing field 'DirectiveArgSet.directive'
        db.alter_column('smartconnectorscheduler_directiveargset', 'directive_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartconnectorscheduler.Directive']))
        # Deleting field 'Stage.package'
        db.delete_column('smartconnectorscheduler_stage', 'package')

        # Adding field 'Command.path'
        db.add_column('smartconnectorscheduler_command', 'path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)
