...
class Command(BaseCommand):
    ...
    def setup(self):
        ...
        schema_data = {
            u'http://rmit.edu.au/schemas/platform/storage/ssh':
                [u'schema for SSH storage platform instances',
                {
            ...
            u'http://rmit.edu.au/schemas/platform/computation/nectar':
                ...
                u'security_group': {'type':models.ParameterName.STRING, 'subtype':'', 'description':'', 'ranking':5, 'help_text':''},
